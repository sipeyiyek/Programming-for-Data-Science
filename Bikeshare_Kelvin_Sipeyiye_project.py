...
CITY_DATA = { 'chicago': r'C:\Users\sipeyiyek\Desktop\Data_Bikeshare\Chicago_2016_Summary.csv',
              'new york city': r'C:\Users\sipeyiyek\Desktop\Data_Bikeshare\NYC_2016_Summary.csv',
              'washington': r'C:\Users\sipeyiyek\Desktop\Data_Bikeshare\Washington_2016_Summary.csv' }
...
def get_filter_month():
    ...
    while True:
        try:
            month = input("    Enter the month with January=1, June=6 or 'a' for all:  ").lower()
        except:
...
def get_filter_day():
    ...
    while True:
        try:
            day = input("    Enter the day with Monday=1, Sunday=7 or 'a' for all:  ").lower()
        except:
...
def get_filters():
    ...
    """
    print_line('=')
    print('\n  Goodday! Let\'s explore some US bikeshare data with Kelvin Sipeyiye!\n')
